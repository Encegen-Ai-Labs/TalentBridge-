...
export default function SimilarJobs({ jobs, excludeId, limit = 9, title = 'Similar jobs you can apply to' }) {
    ...
    const handleViewDetails = (job) => {
        ...
        navigate(`/opportunity/${id}`, { state: { job } });
    };
    ...
    return (
        <section className="similar-jobs-outer">
            <div className="similar-jobs-content">
                ...
                <div className="similar-jobs-slider-container">
                    {totalPages > 1 && (
                        <button 
                            className="similar-arrow prev" 
                            onClick={goPrev} 
                            disabled={page === 0} 
                            ...
                            return (
                                <div className="similar-job-card" key={id}>
                                    ...
                                    <div className="similar-job-meta">
                                        ...
                                        <div className="similar-job-meta-item">
                                            <span className="icon">💼</span> 
                                            <span>{info.salaryMin ? `₹ ${info.salaryMin} - ${info.salaryMax} / month` : 'Not disclosed'}</span>
                                        </div>
                                        {info.duration && (
                                            <div className="similar-job-meta-item">
                                                <span className="icon">⏳</span> 
                ...
                {totalPages > 1 && (
                    <div className="similar-dots-wrapper">
